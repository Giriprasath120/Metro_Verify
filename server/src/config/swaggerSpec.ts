    ...
    schemas: {
      ...
      OfficerLoginRequest: {
        ...
        properties: {
          ...
          email: { type: 'string', example: 'ramanathan.v@lm.telangana.gov.in' },
          password: { type: 'string', example: 'password123' },
        },
      },
      RegisterInstrumentRequest: {
        ...
        properties: {
          ...
          location: { type: 'string', example: 'Osmangunj Wholesale Market, Hyderabad' },
          district: { type: 'string', example: 'Hyderabad North' },
      ...
      CreateApplicationRequest: {
        ...
        properties: {
          ...
          location: { type: 'string', example: 'Gate #2, Osmangunj, Hyderabad' },
      ...
      CreateBulkRequest: {
        ...
        properties: {
          ownerId: { type: 'string', example: 'OWN-101' },
          facilityName: { type: 'string', example: 'Osmangunj Grain Logistics Terminal' },
            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  address: { type: 'string', example: 'Osmangunj Commercial Yard, Hyderabad' },
                },
              },
            },
          },
