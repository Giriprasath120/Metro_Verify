    ...
    const officers = [
      {
        ...
        email: 'ramanathan.v@lm.tn.gov.in',
        passwordHash,
        state: 'Tamil Nadu',
        district: 'Chennai',
    ...
    const owners = [
      {
        ...
        state: 'Tamil Nadu',
        district: 'Chennai',
        address: 'Shop No. 14-16, Wholesale Grain Market, George Town, Chennai - 500012',
        complianceScore: 100,
      },
      {
        id: 'OWN-102',
