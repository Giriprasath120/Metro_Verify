...
export const mockOwners: Owner[] = [
  ...
  },
  {
    ...
    address: 'Shop 18, Charminar Steel Market, Hyderabad',
    complianceScore: 94,
    complianceDeductions: [
...
export const mockOfficers: Officer[] = [
  ...
  },
  {
    ...
    gatcLabName: 'Secunderabad Central Metrology Testing & Calibration Lab'
  },
  {
    id: 'OFF-04',
    name: 'Amit Deshmukh',
...
export const mockInstruments: Instrument[] = [
  ...
  },
  {
    ...
    passportTimeline: [
      ...
      },
      {
        ...
        date: '2026-01-05',
        officerName: 'V. Ramanathan (LMO)',
        note: 'Scheduled for Bowenpally inspection cluster.',
        completed: true
      },
      {
        stage: 'Field-Verified',
      ...
      },
      {
        stage: 'Certificate Issued',
        date: '2026-01-10',
        officerName: 'Legal Metrology Dept, Telangana',
  ...
  },
  {
    ...
    ownerId: 'OWN-101',
    location: 'Mandi Substation HT Panel, Bowenpally, Hyderabad',
    district: 'Hyderabad North',
    state: 'Telangana',
  ...
  },
  {
    ...
    ownerId: 'OWN-109',
    location: 'Charminar Auto Stand Hub, Hyderabad',
    district: 'Hyderabad South',
    state: 'Telangana',
    ...
    passportTimeline: [
      ...
      },
      {
        stage: 'Certificate Issued',
        date: '2026-08-15',
        officerName: 'Legal Metrology Dept, Hyderabad South',
  ...
  },
  {
    ...
    accuracyClass: 'Class III',
    ownerId: 'OWN-101',
    location: 'Loading Bay 4, Bowenpally Mandi, Hyderabad',
    district: 'Hyderabad North',
    state: 'Telangana',
  ...
  },
  {
    ...
    ownerId: 'OWN-101',
    location: 'Grain Weighing Section, Bowenpally, Hyderabad',
    district: 'Hyderabad North',
    state: 'Telangana',
    ...
    passportTimeline: [
      ...
      },
      {
        stage: 'Certificate Issued',
        date: 'Pending',
        officerName: 'LMO Hyderabad North',
  ...
  },
  {
    ...
    accuracyClass: 'Class III',
    ownerId: 'OWN-101',
    location: 'Counter 2, Bowenpally Wholesale Mandi, Hyderabad',
    district: 'Hyderabad North',
    state: 'Telangana',
    lastVerifiedDate: '2025-09-02',
    expiryDate: '2026-09-01',
  ...
  },
  {
    ...
    accuracyClass: 'Class III',
    ownerId: 'OWN-101',
    location: 'Counter 3, Bowenpally Wholesale Mandi, Hyderabad',
    district: 'Hyderabad North',
    state: 'Telangana',
    lastVerifiedDate: '2025-09-02',
    expiryDate: '2026-09-01',
...
export const mockCertificates: Certificate[] = [
  {
    ...
    issuingAuthority: 'Office of the Controller of Legal Metrology, Government of Telangana',
  ...
  },
  {
    ...
    issuingAuthority: 'Secunderabad Central Metrology Testing & Calibration Lab (GATC-TS)',
...
export const mockOfflineQueue: OfflineVerificationItem[] = [
  {
    ...
    location: 'Bowenpally Wholesale Mandi, Hyderabad',
